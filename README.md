...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-02c6vek.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-02c6vek.containers.anotherwebservice.com/
...
```
git clone git@github.com:alokd07/container-02c6vek.git
cd container-02c6vek
```
...
```
docker attach container-02c6vek
```
